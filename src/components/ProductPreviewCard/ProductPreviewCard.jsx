  ...
  return (
    <div className={style.ProductPreviewCard}>
        ...
        <div className={style.Components}>
          <span>
            {`${car.engine_capacity} л (${car.power} л.с. ), ${car.fuel.name}`} ,
          </span>
          <span>
          ...
          </div>
          {
            (car.old_price !== null) ?
              <div className={style.OldPrice}>
                <div className={style.OldPrice__Label}>минимальная цена</div>
